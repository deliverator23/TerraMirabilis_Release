...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_DELICATE_ARCH_DESCRIPTION",		"One tile impassable natural wonder. Adjacent plots yield +1 [ICON_FAITH] Faith, +1 [ICON_SCIENCE] Science, and +1 [ICON_CULTURE] Culture."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_MATTERHORN_DESCRIPTION",	"One tile impassable natural wonder. Appears as a Mountain. Adjacent plots yield +1 [ICON_CULTURE] Culture to adjacent tiles."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_TM_FEATURE_ULURU_DESCRIPTION",		"One tile impassable natural wonder. Adjacent plots yield +2 [ICON_CULTURE] Culture and +2 [ICON_FAITH] Faith."	),

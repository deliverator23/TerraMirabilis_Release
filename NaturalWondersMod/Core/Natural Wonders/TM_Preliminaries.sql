...
VALUES	-- ATTACH
		...
		('MODTYPE_TM_DISTRICTS_APPEAL_YIELD',		'COLLECTION_PLAYER_DISTRICTS',		'EFFECT_ADJUST_DISTRICT_YIELD_BASED_ON_APPEAL'				),
		...
		-- UNIT
		('MODTYPE_TM_INITIATION_YIELD',				'COLLECTION_PLAYER_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_INITIATION_YIELD'						),
		...
		('MODTYPE_TM_ADJUST_UNIT_SPREAD',			'COLLECTION_CITY_TRAINED_UNITS',	'EFFECT_ADJUST_UNIT_SPREAD_CHARGES'							),

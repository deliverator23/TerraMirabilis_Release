...
VALUES  ('ICON_FEATURE_BARRINGER_CRATER',		'ICON_ATLAS_TERRA_MIRABILIS',				0		),
		...
		('ICON_FEATURE_MOSI_OA_TUNYA',			'ICON_ATLAS_TERRA_MIRABILIS',				13		),
		('ICON_FEATURE_NAMIB',					'ICON_ATLAS_TERRA_MIRABILIS',				14		),
		('ICON_FEATURE_VREDEFORT_DOME',			'ICON_ATLAS_TERRA_MIRABILIS',				15		),

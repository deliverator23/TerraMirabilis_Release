...
VALUES	('MODIFIER_TM_FEATURE_SAHARA_EL_BEYDA_ATTACH_IMMUNE_HABOOB',	'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER',	'REQSET_TM_MAP_HAS_FEATURE_WHITEDESERT',	'REQSET_TM_PLAYER_HAS_FEATURE_WHITEDESERT'	),
		('MODIFIER_TM_FEATURE_SAHARA_EL_BEYDA_IMMUNE_HABOOB',			'MODTYPE_TM_PLAYER_EVENT_IMMUNITY',		NULL,										NULL										),
		('MODIFIER_TM_FEATURE_SAHARA_EL_BEYDA_ATTACH_IMMUNE_GRADIENT',	'MODIFIER_ALL_PLAYERS_ATTACH_MODIFIER',	'REQSET_TM_MAP_HAS_FEATURE_WHITEDESERT',	'REQSET_TM_PLAYER_HAS_FEATURE_WHITEDESERT'	),
		('MODIFIER_TM_FEATURE_SAHARA_EL_BEYDA_IMMUNE_GRADIENT',			'MODTYPE_TM_PLAYER_EVENT_IMMUNITY',		NULL,										NULL										);

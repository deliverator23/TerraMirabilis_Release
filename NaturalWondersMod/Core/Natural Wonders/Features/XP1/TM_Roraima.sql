...
VALUES	('MODIFIER_TM_FEATURE_RORAIMA_ATTACH_PLAYERS',	'MODTYPE_TM_ATTACH_ALL_PLAYERS',		'REQSET_TM_PLAYER_HAS_FEATURE_RORAIMA'	),
		('MODIFIER_TM_FEATURE_RORAIMA_JUNGLE_APPEAL',	'MODTYPE_TM_ADJUST_FEATURE_APPEAL',		NULL									);
...
VALUES	('MODIFIER_TM_FEATURE_RORAIMA_ATTACH_PLAYERS',	'ModifierId',	'MODIFIER_TM_FEATURE_RORAIMA_JUNGLE_APPEAL'	),
		('MODIFIER_TM_FEATURE_RORAIMA_JUNGLE_APPEAL',	'FeatureType',	'FEATURE_JUNGLE'							),

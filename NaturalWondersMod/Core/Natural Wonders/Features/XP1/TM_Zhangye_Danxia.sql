...
VALUES	('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_CAMPUS',		'MODTYPE_TM_ATTACH_ALL_CITIES',			'REQSET_TM_CITY_HAS_FEATURE_ZHANGYE_DANXIA'	),
		('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_COMMERCIAL',	'MODTYPE_TM_ATTACH_ALL_CITIES',			'REQSET_TM_CITY_HAS_FEATURE_ZHANGYE_DANXIA'	),
		('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_CAMPUS',				'MODTYPE_TM_ADJUST_CITY_DISTRICTS_GP',	'REQSET_TM_DISTRICT_IS_CAMPUS'				),
...
VALUES	('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_CAMPUS',		'ModifierId',			'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_CAMPUS'		),
		('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_ATTACH_CITIES_COMMERCIAL',	'ModifierId',			'MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_COMMERCIAL'	),
		('MODIFIER_TM_FEATURE_ZHANGYE_DANXIA_GP_CAMPUS',				'GreatPersonClassType',	'GREAT_PERSON_CLASS_SCIENTIST'						),

...
WHERE	FeatureType = 'FEATURE_FOUNTAIN_OF_YOUTH';
	...
	WHERE UnitAbilityType IN ('ABILITY_WATER_OF_LIFE')
	AND EXISTS (SELECT * FROM TM_UserSettings WHERE Setting = 'NW_EFFECTS' AND Value = 1);
...
VALUES	('ABILITY_TM_FEATURE_FOUNTAIN_OF_YOUTH',	'LOC_ABILITY_TM_FEATURE_FOUNTAIN_OF_YOUTH_NAME',	'LOC_ABILITY_TM_FEATURE_FOUNTAIN_OF_YOUTH_DESCRIPTION',	1,			0,							1			);
